...
def test_client_review_page_navigation(
    ...
    assert (
        ...
        "FAIL: Client Review page navigation failed."
    )

    print(
        "PASS: Client Review page opened successfully."
    )
...
def test_client_review_role_with_multiple_words(
    ...
    assert (
        ...
        "FAIL: Client role with multiple words "
...
def test_client_review_long_review(
    ...
    assert (
        ...
        "FAIL: Long review text was not entered correctly."
    )
...
def test_client_review_empty_client_name(
    ...
    assert (
        ...
        "FAIL: Client name validation error "
        "was not displayed."
    )
...
def test_client_review_empty_client_role(
    ...
    assert (
        ...
        "FAIL: Client role validation error "
        "was not displayed."
    )
...
def test_client_review_empty_review(
    ...
    assert (
        ...
        "FAIL: Review text validation error "
        "was not displayed."
    )
...
def test_delete_client_review_without_confirmation(
    ...
    # --------------------------------------------------------
    # STEP 1: Verify client review exists BEFORE deletion
    # --------------------------------------------------------

    assert (
        client_review_page.is_client_review_displayed()
    ), (
        "FAIL: Client review does not exist before "
        "starting the delete test."
    )

    print(
        "PASS: Client review exists before delete operation."
    )
    ...
    print(
        "PASS: Delete icon clicked."
    )

    # --------------------------------------------------------
    # STEP 3: Verify confirmation popup is displayed
    # --------------------------------------------------------

    assert (
        client_review_page.is_delete_confirmation_displayed()
    ), (
        "FAIL: Delete confirmation popup was not displayed."
    )

    print(
        "PASS: Delete confirmation popup displayed."
    )

    # --------------------------------------------------------
    # STEP 4: DO NOT click Yes/Delete or No/Cancel
    # --------------------------------------------------------

    print(
        "INFO: No confirmation option selected."
    )

    time.sleep(2)

    # --------------------------------------------------------
    # STEP 5: Verify client review was NOT deleted
    # --------------------------------------------------------

    assert (
        client_review_page.is_client_review_displayed()
    ), (
        "FAIL: Client review was deleted WITHOUT "
        "selecting Yes/Delete or No/Cancel."
    )

    print(
        "PASS: Client review was NOT deleted without "
        "confirmation."
    )

    # --------------------------------------------------------
    # STEP 6: Verify popup is still displayed
    # --------------------------------------------------------

    assert (
        client_review_page.is_delete_confirmation_displayed()
    ), (
        "FAIL: Confirmation popup disappeared even though "
        "neither Yes nor No was selected."
    )

    print(
        "PASS: Confirmation popup remains displayed."
    )
...
def test_delete_client_review_with_confirmation(
    ...
    # --------------------------------------------------------
    # STEP 1: Verify client review exists
    # --------------------------------------------------------

    assert (
        client_review_page.is_client_review_displayed()
    ), (
        "FAIL: Client review does not exist before deletion."
    )

    print(
        "PASS: Client review exists before deletion."
    )
    ...
    # --------------------------------------------------------
    # STEP 3: Verify confirmation popup
    # --------------------------------------------------------
    ...
    print(
        "PASS: Delete confirmation selected."
    )
    ...
    assert (
        ...
        "FAIL: Client review deletion was not completed."
    )

    print(
        "PASS: Client review deletion completed."
    )

    # --------------------------------------------------------
    # STEP 6: Verify client review no longer exists
    # --------------------------------------------------------

    assert not (
        client_review_page.is_client_review_displayed()
    ), (
        "FAIL: Client review is still displayed after "
        "confirmed deletion."
    )

    print(
        "PASS: Client review is no longer displayed."
    )
