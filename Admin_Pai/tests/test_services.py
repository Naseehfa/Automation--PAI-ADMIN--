...
def test_update_with_empty_service_field(
    ...
    assert services_page.is_edit_interface_open(), (
        "FAIL: Edit interface did not open."
    )
    ...
    assert description.strip(), (
        "FAIL: Existing Description is empty. "
        "Test requires a valid Description."
    )

    # --------------------------------------------------------
    # COMPLETELY DELETE SERVICE NAME DATA
    # --------------------------------------------------------

    services_page.clear_service_name()

    # --------------------------------------------------------
    # VERIFY SERVICE NAME IS COMPLETELY EMPTY
    # --------------------------------------------------------
    ...
    print(
        "Service Name completely cleared."
    )
    ...
    # Edit interface should remain open
    assert services_page.is_edit_interface_open(), (
...
def test_update_with_empty_description_field(
    ...
    assert service_name.strip(), (
        "FAIL: Existing Service Name is empty. "
        "Test requires a valid Service Name."
    )

    # --------------------------------------------------------
    # COMPLETELY DELETE DESCRIPTION DATA
    # --------------------------------------------------------

    services_page.clear_description()

    # --------------------------------------------------------
    # VERIFY DESCRIPTION IS COMPLETELY EMPTY
    # --------------------------------------------------------
    ...
    print(
        "Description completely cleared."
    )
...
def test_update_with_both_mandatory_fields_empty(
    ...
    # --------------------------------------------------------
    # VERIFY EDIT INTERFACE REMAINS OPEN
    # --------------------------------------------------------

    assert services_page.is_edit_interface_open(), (
        "FAIL: Edit interface closed after "
        "invalid update."
    )

    print(
        "PASS: Both mandatory fields were "
        "completely cleared and validated."
    )
