...
def test_add_industry_valid_data():
    ...
    try:
        ...
        assert os.path.isfile(JPG_IMAGE_PATH), (
            f"Valid JPG does not exist:\n{JPG_IMAGE_PATH}"
        )

        # ----------------------------------------------------
        # Generate industry name
        # ----------------------------------------------------
        ...
        assert driver.current_url == INDUSTRY_URL

        print("Industry added:", industry_name)

        # ----------------------------------------------------
        # Refresh page
        # ----------------------------------------------------

        print("Refreshing Industry page...")
        ...
        print("Scrolling down to Industry list...")
        ...
        # ----------------------------------------------------
        # Search for newly added industry
        # ----------------------------------------------------

        print(
            "Searching for newly added industry:",
            industry_name
        )
        ...
        assert industry.wait_until_industry_present(
            ...
            f"New industry was not found after "
            f"refresh and scroll: {industry_name}"
        )
